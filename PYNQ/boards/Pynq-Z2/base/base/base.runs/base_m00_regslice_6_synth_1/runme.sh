...
HD_PWD='/home/eashanw/Audio_open/audio-revamp-soc/PYNQ/boards/Pynq-Z2/base/base/base.runs/base_m00_regslice_6_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log base_m00_regslice_6.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source base_m00_regslice_6.tcl
