...
proc create_hier_cell_trace_analyzer_pmodb { parentCell nameHier } {
  ...
  # Create pins
  create_bd_pin -dir I -from 33 -to 0 data
...
connect_bd_intf_net -intf_net [get_bd_intf_nets iop_pmodb_pmodb_gpio] [get_bd_intf_ports pmodb_gpio] [get_bd_intf_pins slice_pmodb_gpio/gpio]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_1_M04_AXI [get_bd_intf_pins ps7_0_axi_periph_1/M04_AXI] [get_bd_intf_pins segment_stream_0/S_AXI]
  ...
  connect_bd_net -net axi_dma_0_mm2s_introut [get_bd_pins axi_dma_0/mm2s_introut] [get_bd_pins concat_pmodb/In4]
  connect_bd_net -net axi_dma_0_s2mm_introut [get_bd_pins axi_dma_0/s2mm_introut] [get_bd_pins concat_pmodb/In5]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x83C00000 [get_bd_addr_spaces ps7_0/Data] [get_bd_addr_segs segment_stream_0/S_AXI/S_AXI_reg] SEG_segment_stream_0_S_AXI_reg
